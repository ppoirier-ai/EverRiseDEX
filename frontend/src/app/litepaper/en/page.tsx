...
The base price is calculated as: P(Y) = X / Y

This provides a baseline that rises as reserves diminish, ensuring perpetual price appreciation.

Daily Minimum Boost:
To guarantee at least 0.02% growth per 24-hour period, the system applies a daily boost if organic growth falls below this threshold. This boost is temporary and non-compounding, resetting each day.`
    },
    {
